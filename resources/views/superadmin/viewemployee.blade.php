         ...
         <fieldset style="margin-bottom: 30px;margin-left: 0px;border:solid thin gray;border-radius: 10px">
          ...
          <div class="container" style="margin-left: 10px">
            <div class="row">
              ...
              <div class="col-md-2">
                <p style="font-size: 15px"><h5>Name:</h5> {{$employee->fname}} {{$employee->lname}}</p>
              </div>
              <div class="col-md-2">
                <p style="font-size: 15px"><h5>Email:</h5> {{$employee->email}}</p>
              </div>
              <div class="col-md-2">
                <p style="font-size: 15px"><h5>Contact:</h5> {{$employee->contact}}</p>
              </div>
              <div class="col-md-2">
                <p style="font-size: 15px"><h5>Designation:</h5> {{$employee->emp_designation->name}}</p>
              </div>
              <div class="col-md-3">
                <p style="font-size: 15px"><h5>Department:</h5> {{$employee->emp_department->department_name}} Department</p>
              </div>
              @endforeach
           </div>
          </fieldset>
