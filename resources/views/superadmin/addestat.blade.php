...
@section('content')
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="{{URL::to('/show_eduatain')}}">Employemnt Status</a>
          </li>s
          <li class="breadcrumb-item active">Employment Status Creation</li>
        </ol>
    ...
    <div class="card card-register mx-auto mt-4">
      <div class="card-header">Create Employment Status</div>
      <div class="card-body">
      @if ($errors->any())
