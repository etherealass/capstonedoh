                      ...
                      <div class="row">
                        <div class="col-md-12">
                         <div class="table-responsive scrollAble2">
                          ...
                          <div style="float:right;margin-bottom: 10px;margin-right: 10px;margin-top: 10px"><a data-patientid="" data-doctorid="" data-toggle="modal" data-target=""><button class="btn btn-success"><i class="fas fa-fw fa fa-book"></i>Add Notes</button></a></div>
                          @endif
                          <table class="table table-bordered"  width="100%" cellspacing="0" style="font-size: 12px">
                            <thead>
                             <tr>
